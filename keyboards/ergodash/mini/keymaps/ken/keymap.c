...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_RAISE] = LAYOUT(
    ...
    KC_LGUI, _______, _______, _______, _______, _______, _______,                       _______, KC_MINS, KC_EQL , KC_LBRC, KC_RBRC, KC_BSLS, KC_QUOT, \
    KC_LSFT, _______, _______, _______, _______, _______,  KC_TAB,                       KC_SPC , KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_DQUO, \
    _______, _______, _______, KC_LCTL,             LOWER, KC_TAB, _______,     _______, KC_SPC , RAISE,            KC_RALT, _______, _______, _______  \
    ),
