...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * |  GUI |   A  |   S  |   D  |   F  |   G  | EISU |                    | KANA |   H  |   J  |   K  |   L  |   ;  | Enter|
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LGUI,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,  KC_LANG2,                       KC_LANG1, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT , \
    KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_TAB ,                        KC_SPC , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT   , \
    _______, _______, _______, KC_LCTL,            LOWER,   KC_TAB , _______,      _______, KC_SPC , RAISE,            KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
