...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LGUI,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,  _______,                       _______,   KC_H,    KC_J,    KC_K,   KC_L,  KC_SCLN, KC_QUOT, \
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|      |      |      |      |      | Space|                    | KC_L4|      |      |      |      |      |  ESC |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |      |      |      | Ctrl |||||||| Lower| Space|      ||||||||      | KC_L4| Raise||||||||  Alt |      |      |      |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_LOWER] = LAYOUT(
    ...
    KC_LSFT, _______, _______, _______, _______, _______, KC_SPC ,                         KC_L4 , _______, _______, _______, _______, _______, KC_ESC , \
    _______, _______, _______, KC_LCTL,            LOWER, KC_SPC , _______,      _______,  KC_L4 , RAISE,            KC_RALT, _______, _______, _______  \
  ),
  ...
  */
  [_RAISE] = LAYOUT(
    KC_TAB , KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, _______,                       _______, KC_ASTR, KC_LCBR, KC_RCBR, KC_LPRN, KC_RPRN,  KC_DEL, \
